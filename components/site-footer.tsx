        ...
        <div className="grid md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a href={r.facebook} target="_blank" rel="noreferrer" aria-label="Facebook" className="w-11 h-11 rounded-full bg-[#1877F2] hover:opacity-80 transition flex items-center justify-center">
              ...
              <a href={r.tiktok} target="_blank" rel="noreferrer" aria-label="TikTok" className="w-11 h-11 rounded-full bg-black hover:opacity-80 transition flex items-center justify-center">
              ...
              <a href={r.instagram} target="_blank" rel="noreferrer" aria-label="Instagram" className="w-11 h-11 rounded-full bg-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] hover:opacity-80 transition flex items-center justify-center">
              ...
              <a href={r.youtube} target="_blank" rel="noreferrer" aria-label="YouTube" className="w-11 h-11 rounded-full bg-[#FF0000] hover:opacity-80 transition flex items-center justify-center">
